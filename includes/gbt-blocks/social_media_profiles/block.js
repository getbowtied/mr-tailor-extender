( function( blocks, components, editor, i18n, element ) {
	...
	const ServerSideRender		= editor.ServerSideRender;
...
// } = wp.components;
	...
	/* Register Block */
	registerBlockType( 'getbowtied/mt-social-media-profiles', {
		title: i18n.__( 'Social Media Profiles', 'mrtailor' ),
		icon:
		...
		edit: function( props ) {
			...
			return [
				el( 
					InspectorControls, 
					{ 
						key: 'gbt_18_mt_socials_settings'
					},
					el(
						'div',
						{
						...
						el(
							RangeControl,
							{
								key: "gbt_18_mt_socials_font_size",
								value: attributes.fontSize,
								allowReset: false,
								initialPosition: 24,
								min: 10,
								max: 36,
								label: i18n.__( 'Icons Font Size', 'mrtailor' ),
						...
						el(
							ColorSettings,
							{
								key: 'gbt_18_mt_socials_icons_color',
								title: i18n.__( 'Icons Color', 'mrtailor' ),
								colorSettings: [
									{ 
										label: i18n.__( 'Icons Color', 'mrtailor' ),
				...
				el(
					BlockControls,
					{ 
						key: 'gbt_18_mt_socials_alignment_controls'
					},
					el(
						AlignmentToolbar, 
						{
							key: 'gbt_18_mt_socials_alignment',
				...
				el( 
					'div',
					{ 
						key: 		'gbt_18_mt_editor_social_media_wrapper',
						className: 	'gbt_18_mt_editor_social_media_wrapper'
					},
					el(
						'p',
						{
							key: 		'gbt_18_mt_editor_social_media_setup',
							className: 	'gbt_18_mt_editor_social_media_setup',
						},
						i18n.__('Setup social profile links under Appearance > Customize > Social Media', 'mrtailor' ),
					),
				),
				el(
					ServerSideRender,
					{
						block: 'getbowtied/mt-social-media-profiles',
