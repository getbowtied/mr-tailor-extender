...
if ( ! function_exists( 'gbt_18_mt_social_media_editor_assets' ) ) {
    function gbt_18_mt_social_media_editor_assets() {
        ...
        wp_enqueue_style(
            'gbt_18_mt_social_media_editor_styles',
...
//==============================================================================
add_action( 'enqueue_block_assets', 'gbt_18_mt_social_media_assets' );
if ( ! function_exists( 'gbt_18_mt_social_media_assets' ) ) {
    function gbt_18_mt_social_media_assets() {
        
        wp_enqueue_style(
            'gbt_18_mt_social_media_styles',
